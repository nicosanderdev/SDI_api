...
public record UnstarMessageCommand(Guid MessageId, Guid UserId) : IRequest;

public class UnstarMessageCommandHandler : IRequestHandler<UnstarMessageCommand>
{
    private readonly IApplicationDbContext _context;

    public UnstarMessageCommandHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task Handle(UnstarMessageCommand request, CancellationToken cancellationToken)
    {
